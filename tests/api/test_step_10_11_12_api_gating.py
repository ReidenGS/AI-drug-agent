"""Step 10/11/12 API plan_status gating — same behavior as Step 5/6/7/8/9."""
...
@pytest.mark.parametrize("step_num", [10, 11, 12])
def test_step10_11_12_api_returns_409_under_wait_for_input(client: TestClient, step_num: int):
...
@pytest.mark.parametrize("step_num", [10, 11, 12])
def test_step10_11_12_api_returns_409_under_blocked(client: TestClient, step_num: int):
